<template>
  <v-card flat color="grey lighten-3" class="pa-4 pa-sm-8 pa-md-12">
    ...
    >
      <v-col v-for="item in solarServices" :key="item.title" class="">
    ...
    <v-row
      ...
      class="d-flex flex-column flex-sm-row"
    >
      <v-col v-for="item in plantServices" :key="item.title" class="">
        <v-icon large color="primary">mdi-{{ item.icon }}</v-icon>
        <h4 class="text-h6 font-weight-bold mb-2">{{ item.title }}</h4>
        <p class="body-2 ">{{ item.text }}</p>
      </v-col>
    ...
    <v-row
      ...
      class="d-flex flex-column flex-sm-row"
    >
      <v-col v-for="item in chargerServices" :key="item.title" class="">
        <v-icon large color="primary">mdi-{{ item.icon }}</v-icon>
        <h4 class="text-h6 font-weight-bold mb-2">{{ item.title }}</h4>
        <p class="body-2 ">{{ item.text }}</p>
      </v-col>
